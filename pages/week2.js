  ...
  return (
    <main style={{ padding: '2rem', fontFamily: 'sans-serif', textAlign: 'center' }}>      
      <section style={{ marginTop: '3rem', textAlign: 'left', maxWidth: '600px', marginInline: 'auto' }}>
        ...
        <h2 style={{ color: '#ec407a' }}>🗓️ Week 2 저녁 식단표 (2인 × 5일)</h2>
        <p>💰 Megamart 기준 약 185,000동</p>

        <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '1rem', fontSize: '0.95rem' }}>
          <thead>
            <tr style={{ backgroundColor: '#fdecef', color: '#ec407a' }}>
              <th style={{ padding: '0.5rem' }}>요일</th>
              <th style={{ padding: '0.5rem' }}>메뉴 구성</th>
              <th style={{ padding: '0.5rem' }}>주요 재료</th>
            </tr>
          </thead>
          <tbody>
        ...
        <h3 style={{ marginTop: '2rem', color: '#ec407a' }}>🛒 Week 2 장보기 리스트</h3>
        ...
        <p style={{ fontWeight: 'bold' }}>총합: 약 370,000 VND</p>

        <h3 style={{ marginTop: '2rem', color: '#ec407a' }}>✂️ Week 2 재료 손질 가이드</h3>
        <ul style={{ paddingLeft: '1rem', lineHeight: '1.8' }}>
